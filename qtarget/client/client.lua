...
function isInside(BoxZone, coords)
    for i,v in pairs(Zones) do
        if(v["name"] == BoxZone["name"]) then
...
exports("ReturnZones", ReturnZones)
...
Citizen.CreateThread(function()
    exports['qtarget']:AddBoxZone("qtargettest", vector3(-247.3, -1120.1, 23.0), 2.0, 2.0, {
        name="qtargettest",
        heading=347.0,
        debugPoly=false,
        minZ=21.77834,
